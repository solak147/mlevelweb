...
const faqs = [
  ...
  { q: '多少錢？怎麼付款？', a: '月授權 NT$399，透過綠界 ECPay 信用卡一次付清。付款完成後，授權金鑰與下載連結會直接顯示在頁面上，可以下載安裝檔（mlevel.zip）與使用手冊（使用手冊.md）。' },
  ...
  { q: '付款頁面關掉了，要怎麼重新下載？', a: '用頁面上的「找回授權」，填入購買時的 email 與授權金鑰，即可重新取得有效期限與下載連結；安裝檔與使用手冊都可以重新下載，而且拿到的一律是最新版。' },
